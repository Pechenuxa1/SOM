...
def create_survey(
    ...
    survey_number = SurveyNumber(number=session_number)
    db.add(survey_number)
    db.flush()
    ...
    try:
        ...
        delete_files(iqdat_files, "iqdat", survey_number=survey_number.number)
        delete_files(mp4_files, "mp4", survey_number=survey_number.number)
        delete_files(rr_files, "rr", survey_number=survey_number.number)
        delete_files(sm_files, "sm", survey_number=survey_number.number)
        delete_files(tmk_files, "tmk", survey_number=survey_number.number)
        delete_files(txt_files, "txt", survey_number=survey_number.number)
        delete_files(other_files, "other", survey_number=survey_number.number)
